              ...
              <div className='p-6 relative sm:p-4'>
                ...
                <div className="flex justify-between items-center sm:gap-4">
                  <a
                    ...
                    className="text-black hover:text-purple-300 flex items-center transition-colors duration-300 px-4 py-2 bg-rose-50 rounded-md hover:bg-amber-500 hover:text-white sm:px-2"
                  >
