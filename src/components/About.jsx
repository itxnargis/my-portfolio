    ...
    <section id="about" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 to-black text-white">
      <div className="container mx-auto">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <p className="text-lg sm:text-xl !font-light sm:text-lg leading-relaxed transform transition-all duration-500 ease-in-out hover:scale-105">
          ...
          <p className="text-lg sm:text-xl !font-light leading-relaxed transform transition-all duration-500 ease-in-out hover:scale-105">
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg hover:shadow-blue-500/20 transition-all duration-300">
            <h3 className="text-2xl font-semibold mb-4 text-purple-400">What Drives Me</h3>
