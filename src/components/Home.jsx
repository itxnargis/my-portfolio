...
const Home = () => {
  return (
    <div className='min-h-screen flex flex-col justify-center items-center text-center px-4'>
      <h1 className='text-5xl leading-normal md:text-7xl font-bold mb-4 !leading-normal bg-gradient-to-r from-purple-400 to-pink-600 text-transparent bg-clip-text tranform transition-all duration-500 ease-in-out hover:scale-105'>Hi, I'm Nargis</h1>
